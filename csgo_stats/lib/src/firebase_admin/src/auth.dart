...
import 'package:csgo_stats/src/firebase_admin/src/auth/token_generator.dart';
import 'package:csgo_stats/src/firebase_admin/src/auth/token_verifier.dart';
import 'package:openid_client/openid_client.dart';
import 'package:csgo_stats/src/firebase_admin/src/auth/auth_api_request.dart';
...
class Auth implements FirebaseService {
  ...
  Future<String> createCustomToken(
    String uid, [
    Map<String, dynamic> developerClaims = const {},
  ]) async {
